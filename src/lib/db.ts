...
import { RANK_MIN_SENSORS, paths, slug, type SignalKey } from "./site";

/** `Env` is generated by `wrangler types` from wrangler.jsonc — rerun it when a binding changes. */
const DB = () => env.DB;

// Re-exported so the pages that already import from here do not need a second import.
export { RANK_MIN_SENSORS };
