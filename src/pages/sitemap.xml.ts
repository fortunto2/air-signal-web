...
export const GET: APIRoute = async () => {
  ...
  const entries = [
    ...
    // The guide and the handful of pages that are not a place. Small and rarely changing, so it
    // sits beside the country hub rather than inside the nightly data shards.
    abs("/sitemap-guide.xml"),
